...
namespace Sandbox2D.Graphics.ShaderControllers.Quadtree;

public class QuadtreeRenderer : IShaderController, IDisposable
{
    ...
    public QuadtreeRenderer(ShaderProgram shader, int quadtreeMaxHeight, BufferUsageHint hint = BufferUsageHint.StaticDraw)
    {
        Shader = shader;
        Hint = hint;
